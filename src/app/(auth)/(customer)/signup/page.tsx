...
const page = () => {
  return (
    ...
    >
      {" "}
      <div className="w-11/12 xl:w-[60rem] my-10 xl:grid items-center justify-center overflow-hidden grid-cols-12 bg-white rounded-3xl max-w-[90%] mx-auto">
        <div className="hidden xl:flex flex-col items-center justify-center gap-10 h-full col-span-6 bg-blue-200">
          <MyImage
            src={auth.src}
